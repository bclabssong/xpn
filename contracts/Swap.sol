...
contract Swap {
    address owner;
    XPN _xpnTokenAddress;
    
    constructor(XPN xpnAddress) public {
        owner = msg.sender;
        _xpnTokenAddress = xpnAddress;
    }
    
    
    // function setToken(XPN xpnTokenAddress) external {
    //     _xpnTokenAddress = xpnTokenAddress;
    // }
    ...
    function contractBalance() public view returns (uint256) {
        return _xpnTokenAddress.balanceOf(address(this));
    }
    
    function tokenSwap() public returns (bool) {
        uint256 balance =  contractBalance();
        _xpnTokenAddress.burn(balance);
    }
